# # # bm_daemon/agent/handlers/capture_image_cmd.py
# # at the top of the file
# from bm_daemon.common.config import load_config
# _cfg = load_config()
# 
# # for image
# topics = [_cfg["topics"].get("camera_capture_image", "camera/capture/image")]
# 
# import logging
# import os, sys, time
...
# from bm_daemon.transport.spotter import (
#     build_base64_chunks,
...
# bm_camera/handlers/capture_image_cmd.py
...
_cfg = load_config()
topics = [_cfg.get("topics", {}).get("camera_capture_image", "camera/capture/image")]
